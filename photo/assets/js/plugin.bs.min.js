...
function wxShare(config) {
  tar.config({
    tar_token:"7EdxUTg52l95%2FYEIui41cGg7pyL69Nw",   //必填，监测系统分配给此次监测活动的token
    tar_tid: "100562"    //必填，监测系统分配给此次监测活动的id
  ...
  wx.config({
    ...
    jsApiList: config.jsApiList || ["onMenuShareTimeline", "onMenuShareAppMessage"]
  });
  ...
  wx.ready(function() {
    ...
    var shareData64other = {};
    $.extend(shareData64other, shareData64);
    shareData64other.desc = shareData64.title;
    shareData64other.title = shareData64.desc;
    wx.onMenuShareAppMessage(tar.shapeShareAppMessage(shareData64));
    wx.onMenuShareTimeline(tar.shapeShareTimeline(shareData64other));
  })
}